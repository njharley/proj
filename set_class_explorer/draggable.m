function handles = draggable(h,hObject,handles,varargin)
...
if ~isempty(user_endfcn)
    ...
    feval(user_endfcn,h,hObject,handles);           % added by SMB, modified by FB
end
...
if ~isempty(user_movefcn)
    feval(user_movefcn,h,hObject,handles);
end;
